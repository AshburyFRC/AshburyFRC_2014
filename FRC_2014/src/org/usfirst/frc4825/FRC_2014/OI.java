...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("resetLatch", new resetLatch());
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        SmartDashboard.putNumber("Time of driving forward", 0.0);
        ...
        SmartDashboard.putNumber("Max Hammer Pullback Time", 2.0);
        SmartDashboard.putNumber("Timed Hammer Pullback", 1.0);
        SmartDashboard.putNumber("Max Load Bar Reset Time", 2.0);
        SmartDashboard.putBoolean("Hammer latch", false);
