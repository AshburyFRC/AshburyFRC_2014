...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("driveForwardWithoutSensors", new driveForwardWithoutSensors());
        SmartDashboard.putData("driveForwardWithoutSensors2", new driveForwardWithoutSensors2());
        // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        SmartDashboard.putNumber("Time of driving forward", 2.5);
        SmartDashboard.putNumber("Time of driving forward2", 0.0);
        ...
        SmartDashboard.putNumber("Drive Speed", 0.45);
