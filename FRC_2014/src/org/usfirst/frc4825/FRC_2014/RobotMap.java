...
public class RobotMap {
    ...
    public static void init() {
        ...
        hammerLatchSolenoid = new Solenoid(1, 8);
        LiveWindow.addActuator("Hammer", "LatchSolenoid", hammerLatchSolenoid);

        hammerHammerLatchSwitch = new DigitalInput(1, 13);
        LiveWindow.addSensor("Hammer", "HammerLatchSwitch", hammerHammerLatchSwitch);

        hammerShaftResetSwitch = new DigitalInput(1, 3);
        LiveWindow.addSensor("Hammer", "ShaftResetSwitch", hammerShaftResetSwitch);

        armsArmBeltMotorController = new Victor(1, 9);
        LiveWindow.addActuator("Arms", "LeftArmBeltMotorController", (Victor) armsArmBeltMotorController);

        armsArmPositionSolenoid = new Solenoid(1, 7);
        LiveWindow.addActuator("Arms", "ArmPositionSolenoid", armsArmPositionSolenoid);

        // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        cmpr = new Compressor(7, 1);
