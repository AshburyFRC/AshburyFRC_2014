 ...
 *
 */
public class astralcmd extends Command {
    ...
    protected void execute() {
        try {
            ...
            //image = new RGBImage("/testImageon.jpg");// get the sample image from the cRIO flash
            image.write("/ImagE.jpg");
            System.out.println("---get image()");
            //BinaryImage thresholdImage = image.thresholdHSV(105, 137, 230, 255, 133, 183);// keep only green objects
            BinaryImage thresholdImage = image.thresholdHSL(56, 93, 96, 240, 48, 167);
            thresholdImage.write("/ThresholD.bmp");
            System.out.println("---thresholdImage");
            ...
            if (filteredImage.getNumberParticles() > 0) {
                System.out.println("---target or not");
                ...
                for (int i = 0; i < verticalTargetCount; i++) {
                    System.out.println("---operations with vertical target");
                    ...
                    System.out.println("---finish operations with vertical target");
                }
            ...
            System.out.println("---Image catch camera exeption");
            ex.printStackTrace();
