...
public class RobotMap {
	...
	LiveWindow.addActuator("Drive Train", "Right Drive Motor", (Victor) driveTrainRightDriveMotor);
        ...
        launcherLauncherMotor = new Victor(1, 3);
	LiveWindow.addActuator("Launcher", "Launcher Motor", (Victor) launcherLauncherMotor);
        
        conveyorBeltBeltMotor = new Victor(1, 4);
	LiveWindow.addActuator("Conveyor Belt", "Belt Motor", (Victor) conveyorBeltBeltMotor);
