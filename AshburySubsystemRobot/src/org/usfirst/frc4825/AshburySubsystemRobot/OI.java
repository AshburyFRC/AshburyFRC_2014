...
public class OI {
    ...
    public SendableChooser reverseModeChooser = null;
    public OI() {
        ...
        SmartDashboard.putData("Test Both Motors", new TestBothMotors());
        SmartDashboard.putData("Reverse Launcher", new ReverseLauncher());
        SmartDashboard.putData("Test Auto Command", new TestAutoCommand());
        SmartDashboard.putData("Auto Frisbee Load Delay Command", new AutoFrisbeeLoadDelayCommand());
	...
	SmartDashboard.putNumber("Test Right Motor Speed", 0.5);
     	...
     	SmartDashboard.putNumber("Launcher Front Motor Speed", 0.3);
     	SmartDashboard.putNumber("Launcher Back Motor Speed", 0.7);
     	SmartDashboard.putNumber("Launcher Spin Up Time", 1.5);
     	SmartDashboard.putNumber("Launcher Spin Up Percent", 0.85);
     	SmartDashboard.putNumber("Auto Load Delay", 2.0);
        
        reverseModeChooser = new SendableChooser();
	reverseModeChooser.addDefault("Forward", MotorDirectionType.FORWARD_DIRECTION);
	reverseModeChooser.addObject("Reverse", MotorDirectionType.REVERSE_DIRECTION);
	SmartDashboard.putData("Motor Direction Type", reverseModeChooser); 
        SmartDashboard.putNumber("Time of driving forward", 2.0);
        SmartDashboard.putNumber("Time of driving backward", 2.0);
        ...
        */
        ...
        SmartDashboard.putData("Solve quadratic equation", new solveQuadraticEquation());
        SmartDashboard.putNumber("a", 0.0);
        SmartDashboard.putNumber("b", 0.0);
        SmartDashboard.putNumber("c", 0.0);
