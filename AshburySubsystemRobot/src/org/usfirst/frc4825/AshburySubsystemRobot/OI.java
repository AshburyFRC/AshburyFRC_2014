...
public class OI {
    ...
    public JoystickButton activateConveyorBelt;
    public JoystickButton fireLoadLauncher;
    ...
    public OI() {
        ...
        fireLoadLauncher = new JoystickButton(joystick2, 2);
        fireLoadLauncher.whenPressed(new LoadLauncher());
        activateConveyorBelt = new JoystickButton(joystick2, 1);
        activateConveyorBelt.whileHeld(new ActivateBelt());
        joystick1 = new Joystick(1);
        
        activateLauncherButton = new JoystickButton(joystick1, 1);
        activateLauncherButton.whileHeld(new ActivateLauncher());
        ...
        SmartDashboard.putData("Activate Belt", new ActivateBelt());
	...
	SmartDashboard.putNumber("Test Right Motor Speed", 0.5);
     	...
     	SmartDashboard.putNumber("Launcher Motor 1 Speed", 0.2);
     	SmartDashboard.putNumber("Launcher Motor 2 Speed", 0.2);
    }
