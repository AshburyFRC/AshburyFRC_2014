...
public class ConveyorBelt extends Subsystem {
    ...
    SpeedController beltMotor = RobotMap.conveyorBeltBeltMotor;
    DigitalInput frisbyLoadedSwitch = RobotMap.conveyorBeltFrisbyLoadedSwitch;
    ...
    public boolean beltMotorOn()
    {
        return beltMotorOn;
    }
    
    public boolean isFrisbeeLoaded()
    {
        return frisbyLoadedSwitch.get() == true;
    }
